...
const NewsUpdates = () => {
  const newsItems = [
    {
      id: 1,
      title: 'New Token Bridge Partnership with Stacks',
      excerpt: 'APT Casino partners with Stacks to provide seamless cross-chain token transfers with lower fees.',
      date: '2025-05-08',
    ...
    {
      id: 2,
      title: 'STX Governance Proposal: Community Jackpots',
