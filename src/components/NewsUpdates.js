...
const NewsUpdates = () => {
  const newsItems = [
    {
      id: 1,
      title: 'New Token Bridge Partnership with 0G Network',
      excerpt: 'APT Casino partners with 0G Network to provide seamless cross-chain token transfers with lower fees.',
      date: '2025-05-08',
    ...
    {
      id: 2,
      title: 'OG Governance Proposal: Community Jackpots',
